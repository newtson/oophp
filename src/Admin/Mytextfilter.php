...
class Mytextfilter
{
    ...
    public function parse($text, $filter)
    {
        ...
        /*$res = "";
        if ($filter == "bbcode") {
            $res = $this->bbcode2html($text);
        } else if ($filter == "link") {
            $res = $this->makeClickable($text);
        } else if ($filter == "markdown") {
            $res = $this->markdown($text);
        } else if ($filter == "nl2br") {
            $res = $this->nl2br($text);
        }
        return $res;*/
    }
    ...
    {
        // hämtat från lärarens exempelfil
    ...
    {
        // hämtat från lärarens exempelfil markdown.php
